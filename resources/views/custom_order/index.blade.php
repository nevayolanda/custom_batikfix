            ...
            <table class="table table-hover">
                ...
                <tbody>
                    @forelse($orders as $item)
                        <tr>
                            <td><strong>#{{ $item->id_custom }}</strong></td>
                            ...
                            <td>
                                <a href="{{ route('custom_order.edit', $item->id_custom) }}" class="btn btn-sm btn-warning">Edit</a>
                                <form action="{{ route('custom_order.destroy', $item->id_custom) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
